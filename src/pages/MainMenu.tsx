...
const SOCIAL_LINKS = [
  {
    label: 'GitHub',
    url: 'https://github.com/gabrielgusn',
    viewBox: '0 0 98 96',
  ...
  {
    label: 'LinkedIn',
    url: 'https://linkedin.com/in/gabrielgusn',
    viewBox: '0 0 24 24',
          ...
          <div className="mc-button-row">
            {SOCIAL_LINKS.map((item) => (
              <button
                ...
                onClick={() => { playClick(); window.open(item.url, '_blank') }}
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox={item.viewBox} width="12" height="12" fill="white" aria-hidden="true" style={{ display: 'inline-block', verticalAlign: 'middle', marginRight: '6px' }}>
                  <path d={item.d} />
                </svg>
